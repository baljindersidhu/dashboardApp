...
(function(){
	...
	LandingPageController.$inject = ['$mdToast', '$mdSidenav', '$q', '$timeout', 'SideNavButtonFactory', 'SideNavActionFactory'];
	function LandingPageController($mdToast, $mdSidenav, $q, $timeout, SideNavButtonFactory, SideNavActionFactory){
		var vm                = this;
		vm.sidenavId          = 'left';
